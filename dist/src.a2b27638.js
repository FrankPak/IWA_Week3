...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var url, municipalityData, municipalityJSON, SecondUrl, employmentData, employmentJSON, index, key, tr, td1, td2, td3, td4, employment, population, employmentPercentage;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return fetch(url);
        case 3:
          municipalityData = _context.sent;
          _context.next = 6;
          return municipalityData.json();
        case 6:
          municipalityJSON = _context.sent;
          SecondUrl = "https://statfin.stat.fi/PxWeb/sq/5e288b40-f8c8-4f1e-b3b0-61b86ce5c065";
          _context.next = 10;
          return fetch(SecondUrl);
        case 10:
          employmentData = _context.sent;
          _context.next = 13;
          return employmentData.json();
        case 13:
          employmentJSON = _context.sent;
          //console.log(municipalityJSON.dataset.dimension.Alue.category.label);
          //console.log(municipalityJSON.dataset.value);
          index = 0;
          for (key in municipalityJSON.dataset.dimension.Alue.category.label) {
            ...
            employment = parseInt(employmentJSON.dataset.value[index], 10);
            population = parseInt(municipalityJSON.dataset.value[index], 10);
